...
import { characterIntros, characterTitles, characterSort } from "./character/intro.js";
...
if (!lib.config.characters.includes("水泊娘山")) lib.config.characters.remove("水泊娘山");
...
game.import("extension", function () {
	return {
		...
		package: {
			...
			intro: "推荐使用本体1.11.4及以上版本，欢迎加下群反馈或下载更新版本。" + "<br>" + "拓展群：" + "<br>" + "<img style=width:238px src=" + lib.assetURL + "extension/水泊娘山/main/image/mess/sh_gChat.png>",
			author: "Mushi",
